...
class RequestService extends BaseService {
  ...
  async list({
    ...
    addFilterParam(params, 'asset.connection.tiers.customer.id', assetTiersCustomerId);
    addFilterParam(params, 'asset.connection.tiers.tier1.id', assetTiersTier1Id);
    addFilterParam(params, 'asset.connection.tiers.tier2.id', assetTiersTier2Id);
