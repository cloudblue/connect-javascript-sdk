...
class ProductVersionResource extends GenericResource {
   ...
   *
   * @returns  {ProductActionResource} The instance of the ``ProductActionResource`` class for a product/version.
   */
...
class ProductResource extends GenericResource {
   ...
   *
   * @returns  {ProductActionResource}  An instance of the ``ProductActionResource`` for the product.
   */
  actions(id) {
    return new ProductActionResource(this._client, `${this.baseUri}/${id}/actions`);
  }
   ...
   * @param   {string}  id  The unique identifier of the ``Product``.
   *
   * @returns  {ProductVersionResource}  An instance of the ``ProductVersionResource`` for the product.
   */
   ...
   * @param   {string}  id  The unique identifier of the ``Product``.
   *
   * @returns  {ProductConfigurationResource}  An instance of the ``ProductConfigurationResource`` for the product.
   */
