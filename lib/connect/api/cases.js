 ...
 * @category Resources
 */
class CaseCommentsResource extends GenericResource {}
...
class CaseResource extends GenericResource {
  ...
  constructor(client) {
    ...
    this.comments = memoizeWith(identity, this.comments);
   ...
   */
  comments(id) {
    return new CaseCommentsResource(this._client, `${this.baseUri}/${id}/comments`);
  }
